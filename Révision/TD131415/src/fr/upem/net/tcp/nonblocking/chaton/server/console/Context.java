...
public class Context {
    ...
    private final ServerChatonWithConsole server; // we could also have Context as an instance class, which would naturally
    ...
    public Context(ServerChatonWithConsole server, SelectionKey key) {
        this.key = key;
