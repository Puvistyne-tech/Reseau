...
public class OnDemandConcurrentLongSumServer {
    ...
    public OnDemandConcurrentLongSumServer(int port, int nbClients) throws IOException {
    ...
    public static void main(String[] args) throws NumberFormatException, IOException {
        var server = new OnDemandConcurrentLongSumServer(Integer.parseInt(args[0]), Integer.parseInt(args[1]));
        server.launch();
    }
}
